...
impl Contract {
    ...
    pub fn add_event(&mut self, title: String, description: String) {
    ...
    pub fn add_vote(&mut self, id:usize){
        ...
        env::log_str("Vote submitted for this event!");
...
mod tests {
    ...
    fn add_project() {
        ...
        contract.add_event(
            "Abstract Movies".to_string(),
            "everyone just do msg".to_string());
    ...
    fn add_voter() {
        ...
        contract.add_event("Abstract Movies".to_string(), "everyone just do msg".to_string());
